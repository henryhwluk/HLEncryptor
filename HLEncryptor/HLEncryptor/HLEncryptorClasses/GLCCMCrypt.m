...
NSString *const GLCCMCryptErrorDomain  = @"com.glccmcrypt.CryptError";

@implementation GLCCMCrypt
...
- (void)encryptStreamWithUrl:(NSURL *)url
    ...
    dispatch_queue_t backgroundQueue = dispatch_queue_create("com.glccm.bgqueue", NULL);
    ...
    dispatch_async(backgroundQueue, ^(void) {
        ...
        GLCCM *ccmIstance = [[GLCCM alloc] initWithKey:_key
                                                    iv:_iv
                                                 adata:_adata
...
- (NSError *)createErrorObject:(NSString *)message
    ...
    return [[NSError alloc] initWithDomain:GLCCMCryptErrorDomain
                                      code:number
                                  userInfo:errorDict];
}
